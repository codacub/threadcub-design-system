...
// SocialButton component interface
...
export const SocialButton: React.FC<SocialButtonProps> = ({
  ...
  const buttonText = text || defaultText[provider]
  ...
  const buttonStyles: React.CSSProperties = {
    ...
    border: `1px solid ${disabled ? 'var(--color-gray-300)' : 'var(--color-gray-300)'}`,
  ...
  // GitHub icon
  const GitHubIcon = () => (
    <svg viewBox="0 0 24 24" fill="#333" style={iconStyles}>
