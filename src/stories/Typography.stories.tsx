...
const Heading: React.FC<HeadingProps> = ({
  ...
  const baseStyles: React.CSSProperties = {
    fontFamily: 'var(--font-family-title)', // Use title font for headings
  ...
  // Fixed: Use proper conditional rendering instead of React.createElement
  if (level === 1) {
